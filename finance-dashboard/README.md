...
Smart Observations: Auto-generated insights based on spending habits (e.g., month-over-month comparisons and top spending categories).
Data Export: Export your filtered transaction history to a CSV file with a single click.
Data Persistence: Transactions are saved locally using the browser's `localStorage` so data is retained across sessions.
Dark Mode UI: A sleek, modern, and polished dark interface with smooth Framer Motion animations.
